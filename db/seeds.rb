...
HomeworkFile.create(description: Faker::Lorem.sentence, homework_id: 1, file: File.new('public/homework_files/hw1.pdf'))
HomeworkFile.create(description: Faker::Lorem.sentence, homework_id: 2, file: File.new('public/homework_files/hw1.pdf'))
HomeworkFile.create(description: Faker::Lorem.sentence, homework_id: 3, file: File.new('public/homework_files/hw1.pdf'))
HomeworkFile.create(description: Faker::Lorem.sentence, homework_id: 4, file: File.new('public/homework_files/hw1.pdf'))
